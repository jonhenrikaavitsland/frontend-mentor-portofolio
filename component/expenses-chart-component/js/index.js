...
const barThursday = document.querySelector(".bar-thu");
const barFriday = document.querySelector(".bar-fri");
const barSaturday = document.querySelector(".bar-sat");
const barSunday = document.querySelector(".bar-sun");
